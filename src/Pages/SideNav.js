    ...
    return (
        <div class="drawer drawer-mobile">
            ...
            <div class="drawer-side">
                ...
                <ul class="menu p-4 overflow-y-auto w-32 bg-gradient-to-b from-[#E9DDFE] to-[#f4f6f8] text-base-content shadow-3xl rounded-3xl">
                    ...
                    <div className="flex flex-col items-center gap-5 my-auto">
                        ...
                        <div className="flex flex-col justify-center bg-white w-[70px] h-28 rounded-full cursor-pointer">
                            <FontAwesomeIcon icon={faPlusCircle} className="text-orange-800 mb-1" />
