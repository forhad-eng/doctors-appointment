import { faBell, faPhone, faVideo } from '@fortawesome/free-solid-svg-icons'
                ...
                <div className="treatment mt-3">
                    <div className="border-r-2 border-gray-300 pr-10">
                        ...
                        <div className="text-primary font-bold bg-white rounded-2xl flex justify-center gap-5 mt-6 py-6 px-10">
                            {' '}
                            &lt; <span className="line-through">26</span> <span>27</span> <span>28</span>{' '}
                            <span className="line-through">29</span> <span className="line-through">30</span>{' '}
                            <span className="line-through">31</span> <span className="line-through">01</span> &gt;
                        </div>
                    </div>
                    <div className="flex gap-3 bg-[#F5F7F9] rounded-2xl p-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500"><small>11:30 AM</small></p>
